  ...
  return `<form class="class-editor" onsubmit="saveClassForm(event,'${mode}')">
    ...
    <div class="editor-layout">
      ...
      <div class="editor-sections">
        ...
        <section class="panel editor-section" id="editor-cohort"><div class="editor-section-head"><i>2</i><div><h2>수강 기간</h2><p>클래스를 실제로 수강할 수 있는 시작일과 종료일만 설정합니다. 판매 기간과 가격은 상품 관리에서 설정합니다.</p></div><span>필수</span></div><div class="editor-fields"><label>수강 시작일 <em>*</em><input required type="date" value="2026-07-05"></label><label>수강 종료일 <em>*</em><input required type="date" value="2026-08-02"></label></div></section>
