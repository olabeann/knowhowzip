...
const saleProducts=[
  {id:'prd-intro-pass',membershipGrade:'챌린저',name:'경매 기초 클래스 이용권',desc:'경매 낙찰 기초반을 90일 동안 수강할 수 있는 상품',price:190000,period:'결제일로부터 90일',periodType:'결제일 기준',periodDays:90,courses:['경매 낙찰 기초반'],status:'판매중',paymentCount:18},
  {id:'prd-middle-pass',membershipGrade:'프로',name:'경매 기초·권리분석 이용권',desc:'기초 클래스와 권리분석 실전반을 단계별로 수강',price:390000,period:'결제일로부터 120일',periodType:'결제일 기준',periodDays:120,courses:['경매 낙찰 기초반','권리분석 실전반'],status:'판매중',paymentCount:11},
  {id:'prd-field-package',membershipGrade:'마스터',name:'경매 실전 패키지',desc:'기초·권리분석·임장을 한 번에 구성',price:790000,period:'지정 수강기간',periodType:'지정 수강 기간 기준',periodDays:'',courses:['경매 낙찰 기초반','권리분석 실전반','현장 임장 마스터'],status:'준비중',paymentCount:0},
  {id:'prd-basic-pass',membershipGrade:'챌린저',name:'경매 낙찰 기초반 이용권',desc:'경매 낙찰 기초반 단일 클래스 수강 상품',price:290000,period:'2026.07.05 ~ 08.02',periodType:'지정 수강 기간 기준',periodDays:'',courses:['경매 낙찰 기초반'],status:'판매중',paymentCount:24}
];
...
function renderProductEditor(mode='create',productId=''){
  ...
  const current=product||{id:'',membershipGrade:'챌린저',name:'새 상품',desc:'상품에 포함된 클래스와 수강 흐름을 설명해 주세요.',price:290000,period:'결제일로부터 90일',periodType:'결제일 기준',periodDays:90,courses:['경매 낙찰 기초반'],status:'판매중',paymentCount:0};
  return `<form class="product-editor" onsubmit="saveProductForm(event,'${mode}')">
    <div class="editor-head product-editor-head"><button type="button" class="editor-back" onclick="showAdminView('products')">← 상품 관리</button><div><span>${editing?'Product editing':'Product setup'}</span><h1>${editing?'상품 수정':'새 상품 만들기'}</h1><p>${locked?'결제 이력이 있는 상품은 상품 정보만 수정할 수 있습니다. 포함 클래스, 부여 등급, 가격, 이용 기간, 정책은 잠겨 있습니다.':'상품에 포함할 클래스를 선택하고, 구매 후 부여할 수강생 등급을 설정합니다.'}</p></div><div class="editor-actions product-editor-actions"><label>노출 상태<select><option ${selectedOption('판매중',current.status)}>공개</option><option ${selectedOption('비공개',current.status)}>비공개</option></select></label><button type="submit" class="btn primary">${editing?'변경사항 저장':'상품 등록'}</button></div></div>
    <details class="product-setup-hero panel"><summary><div><span>상품 구조 안내</span><h2>상품 구매 결과로 등급과 클래스 권한을 부여합니다</h2></div><em>자세히 보기</em></summary><div class="product-setup-detail"><p>상품 유형을 나누지 않고, 포함 클래스를 자유롭게 구성합니다. 사용자가 결제하면 지정한 수강생 등급이 자동 부여되고, 포함 클래스가 내 학습에 표시됩니다.</p><ul><li>상품 = 가격·포함 클래스·부여 등급</li><li>클래스 = 영상 강의·자료·FAQ</li><li>등급 = 결제 후 자동 부여되는 수강생 상태</li></ul></div></details>
