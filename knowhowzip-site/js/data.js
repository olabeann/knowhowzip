...
const creators=[
  {id:'mmoh',name:'애매모홈',handle:'@mmoh',cat:'부동산·경매',verified:true,logoType:'house',registeredAt:'2026-07-01T09:00:00+09:00',
   ...
   products:[
     P({id:'mmoh-basic',title:'경매 낙찰 기초반 · 4주 완성',registeredAt:'2026-07-01T10:00:00+09:00',tag:'BEST',rate:4.9,reviews:312,price:290000,orig:390000,
     ...
     P({id:'mmoh-right',title:'권리분석 실전반 · 위험물건 거르기',registeredAt:'2026-07-08T10:00:00+09:00',tag:'심화',rate:4.8,reviews:178,price:390000,orig:450000,
     ...
     P({id:'mmoh-basic-right-package',title:'경매 기초+권리분석 패키지',registeredAt:'2026-07-15T10:00:00+09:00',tag:'패키지',rate:4.9,reviews:84,price:590000,orig:840000,
        requirement:{type:'none',label:'처음 참여 가능',message:'사전 수강 이력 없이 신청할 수 있습니다.'},
     ...
     P({id:'mmoh-field',title:'현장 임장 마스터 · 발품 전략',registeredAt:'2026-07-22T10:00:00+09:00',tag:'현장',rate:4.9,reviews:96,price:450000,orig:520000,isPublic:false,
