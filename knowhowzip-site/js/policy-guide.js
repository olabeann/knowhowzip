(function(){
  ...
  const POLICIES=[
    ...
    {id:"public.learning",pages:["public"],selector:"#view-mypage .learning-group",type:"수강 권한 · 진도",title:"내 학습 클래스 표시 정책",summary:"구매 기록이 아니라 현재 수강 권한이 있는 클래스 목록을 표시합니다.",rules:["영상은 재생 전 수강 전, 실제 재생 시작 후 수강 중, 마지막 구간 도달 후 수강 완료로 표시합니다.","수강 완료 상태는 다시 재생해도 이전 상태로 되돌리지 않습니다.","수강 종료 클래스는 콘텐츠 접근을 제한합니다.","영상, 자료, 운영 안내와 FAQ를 클래스 안에서 제공합니다."],spec:"PRODUCT_SPEC §5.5 · §14.5"},
