(function(){
  ...
  const POLICIES=[
    ...
    {id:"admin.class-list",pages:["creator-admin"],selector:".product-admin-grid",type:"목록 UI",title:"클래스 관리 목록 정책",summary:"수강생에게 노출·판매되는 클래스의 운영 정보를 표시합니다.",rules:["클래스명, 가격, 기간, 상태, 수강 조건과 연결 콘텐츠를 표시합니다.","우측 메뉴는 수정, 복제, 삭제를 제공합니다.","카드 메뉴에는 미리보기를 넣지 않습니다.","수강생 화면에서는 상품이 아니라 클래스라는 명칭을 사용합니다."],spec:"PRODUCT_SPEC §6.4 · §14.7"},
    ...
    {id:"admin.refund",pages:["creator-admin"],selector:"#product-refund",type:"플랫폼 공통",title:"환불 정책 적용 기준",summary:"환불 정책은 클래스별로 입력하지 않고 플랫폼 공통 정책을 적용합니다.",rules:["현재 정책 내용은 조정 중입니다.","확정 전에는 클래스별 환불 문구를 저장하지 않습니다.","정책 확정 후 모든 클래스 결제 화면에 동일하게 적용합니다."],spec:"PRODUCT_SPEC §6.4 · 7단계 / §14.6"},
    ...
    {id:"public.payments",pages:["public"],selector:"#view-account .payment-history",type:"결제 이력",title:"결제 내역 표시 정책",summary:"사용자 본인의 클래스 결제·취소·환불 상태만 표시합니다.",rules:["결제일, 클래스, 금액과 결제 상태를 표시합니다.","PG와 서버의 주문 상태를 동기화합니다.","환불 완료 시 수강 권한도 플랫폼 정책에 따라 갱신합니다."],spec:"PRODUCT_SPEC §5.6 · §14.6"},
