(function(){
  ...
  const POLICIES=[
    ...
    {id:"admin.content-list",pages:["creator-admin"],selector:".class-admin-grid",type:"데이터 관계",title:"강의 콘텐츠와 클래스",summary:"강의 콘텐츠는 영상, 강의에 필요한 자료를 업로드할 수 있습니다.",rules:["해당 콘텐츠는 분리해서 등록하고 클래스에서 판매할 구성으로 사용할 수 있습니다.","한 콘텐츠는 여러 개의 클래스 안에서 운영할 수 있습니다."],spec:"PRODUCT_SPEC §4.1 · §6.2 · §13.1"},
    {id:"admin.class-list",pages:["creator-admin"],selector:".product-admin-grid",type:"상태 · 이동",title:"클래스 관리 기준",summary:"클래스는 수강생에게 판매되는 단위이며 공개와 비공개를 함께 관리합니다.",rules:["카드 뱃지는 공개·비공개 상태만 표시하고 모집 가능 상태는 별도 뱃지로 표시하지 않습니다.","카드 선택 시 해당 클래스 수정 화면으로 이동합니다.","결제 가능 여부는 공개 상태와 상시·날짜 지정 모집 방식을 함께 확인합니다."],spec:"PRODUCT_SPEC §4.11 · §6.4 · §14.4"},
    {id:"admin.content-steps",pages:["creator-admin"],selector:".class-editor-steps",type:"단계형 입력",title:"강의 콘텐츠 등록 단계",summary:"기본 정보와 영상·자료를 두 단계로 나누어 입력합니다.",rules:["한 번에 한 단계만 표시하고 단계가 바뀌어도 작성한 내용과 선택한 파일을 유지합니다.","상단 단계 또는 이전·다음 버튼으로 입력 영역을 전환합니다.","저장 시 두 단계를 모두 검증하고 오류가 있으면 해당 단계로 전환합니다."],spec:"PRODUCT_SPEC §6.3"},
    {id:"admin.unsaved-editor",pages:["creator-admin"],selector:".class-editor,.product-editor",type:"이탈 방지",title:"미저장 변경사항 보호",summary:"작성 내용이 바뀐 편집 화면에서 나갈 때 저장되지 않는다는 확인 모달을 표시합니다.",rules:["계속 작성하면 현재 입력값과 화면을 유지합니다.","저장하지 않고 나가기를 명시적으로 선택한 경우에만 내용을 폐기합니다.","변경이 없거나 저장이 완료된 경우에는 확인하지 않습니다.","새로고침·탭 닫기·외부 이동에는 브라우저 기본 경고를 사용합니다."],spec:"PRODUCT_SPEC §6.3~6.4"},
